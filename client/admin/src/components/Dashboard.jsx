...
export default function Dashboard() {
    ...
    useEffect(() => {
        ...
        const searchedcandidates = data.filter(val => val.state.data.email.includes(value))
        setdata(searchedcandidates)
    ...
    return (
        <div>
            ...
            <div className="flex w-full justify-center items-center">
                ...
                <div classname="ml-2"><i onclick={()=>setrefresh(true)} className="undo icon ml-2 cursor-pointer"/></div>
            </div>
