			...
			<div className="flex mt-4 justify-center items-center">
				<div className="bg-white rounded-md p-5 m-4 mb-8 text-center w-11/12 lg:w-2/3">
					...
					<div className="mt-6">
						...
						<button
							onClick={() => {history.push("/video"); video_status = true}}
							className="ui primary button"
						>
							Video
						</button>
